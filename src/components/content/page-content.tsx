...
// Everything under the canvas. Five short blocks and a footer: the canvas is the
// product, and this is the manual and the proof behind it, not a second sales
// page.
//
// Order is fixed by what a $100 buyer wants first (ticket 07):
...
import { BANNER, MAX_BLOCK, PRICE_PER_SQUARE, SQUARE_COUNT } from "@/lib/board/geometry";
  ...
  return (
    <div>
      ...
      <footer className="border-hairline border-t">
        <div className="text-faint mx-auto flex w-full max-w-[1180px] items-baseline gap-3 px-4 py-8 pb-32 text-[12px] lg:px-8">
          <span className="font-display text-ink text-[14px]">200 SQUARES</span>
          <span data-numeric>· {SQUARE_COUNT} squares + 1 banner</span>
        </div>
      </footer>
    </div>
  );
